...
# MAGIC %md
# MAGIC # Acme Media Ad Events Data Generator
# MAGIC Use this notebook to simulate ad event data landing in the Auto Loader source path.
# MAGIC Run this in one cluster while the pipeline runs in another to observe real-time ingestion.
...
def generate_event(late=False):
 ...
 "consent_flag": random.random() > 0.02, # ~2% non-consented will be filtered in Silver
...
# MAGIC %md
# MAGIC ## Verify Raw Data
# MAGIC Run this after generation to inspect raw event counts by type.
